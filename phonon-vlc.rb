...
class PhononVlc <Formula
  ...
  def patches
    ...
    return [ "https://gist.github.com/raw/4380358/16a7252c04c603e9d3c9a64d8b9c4c3adf97798e/phononvlc-check-bundle-patch.diff",
             "https://gist.github.com/lfranchi/2916817/raw/4bc649a2acd2eba1f15d72e0d77a36012ed50080/phonon-vlc-set-plugin-path.patch",
             "https://gist.github.com/lfranchi/4105819/raw/670e93027417ec36ff730ada6abbc2e8b305c3ae/phonon-vlc-optimize-debug" ]
  end
end
